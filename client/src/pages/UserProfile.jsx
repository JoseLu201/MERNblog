...
const UserProfile = () => {
  ...
  //redirect to login page for any user not logged in
  useEffect(() => {
    if(!token) {
      navigate('/login')
    }
  ...
  const updateUserDetails = async (e) => {
    ...
    try {
      ...
      const response = axios.patch(`${process.env.REACT_APP_BASE_URL}/users/edit-user`, userData, {withCredentials: true, headers: {Authorization: `Bearer ${token}`}})
